    ...
    try:
        ...
        if whatToAsk == "Basic":
            ...
            generated_text = llm.invoke(
                "Please answer for this question. in " + language + ". " + input_text
            )
            ...
            generated_text = chain.invoke(
                {
                    "input": "Please answer for this question. in "
                    + language
                    + ". "
                    + input_text
                }
...
def main():
    ...
    whatToAsk = st.radio(
        ...
        captions=[
            "Simplest way.",
            "Use ChatPromptTemplate with chain.",
            "Add StrOutputParser to the chain",
        ],
    )
        ...
        if api_key:
            with st.spinner("Wait for it..."):
                ...
                generated_text = generate_text(
                    api_key, input_text, whatToAsk, selected_language
                )
